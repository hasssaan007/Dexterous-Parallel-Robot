function ijb=inverse_jacob_hexapod3(A1,A2,A3,A4,A5,A6,A7,B1,B2,B3,B4,B5,B6,B7)
    %% Find the inverse jacobian matrix using vectorial analysis of the stewart platform with anb infinite circular movemente
