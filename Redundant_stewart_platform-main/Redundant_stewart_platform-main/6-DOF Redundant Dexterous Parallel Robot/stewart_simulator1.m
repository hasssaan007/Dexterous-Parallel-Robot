...
%z = 0.015*sin(t);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% vector x, y, z to plot circle in the space 
...
vectz=[0];
    ...
    writerObj = VideoWriter('hexapo-sim1.avi');
...
for k = 1:length(z);
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ijb=inverse_jacob_hexapod(A1,A2,A3,A4,A5,A6,B1,B2,B3,B4,B5,B6);
    %ijbvect(:,:,i)=ijb;
    condnumber(k)=cond(ijb)
...
%% Calculate the inverse of condnumer matrix
condnumberinv=1./condnumber;
figure()
plot(condnumberinv)
title('Inverse of Condition Number')
xlabel('Time (s)')
ylabel('Inverse of Condition Number')